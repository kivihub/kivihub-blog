...
- [0.TroubleShooting](blog/0.TroubleShooting)
	...
	- [1.观察日志](blog/0.TroubleShooting/1.观察日志)
		- [1.为什么我的EL在测试和线上环境结果不同](blog/0.TroubleShooting/1.观察日志/1.为什么我的EL在测试和线上环境结果不同.md)
		- [2.fastjson升级不兼容的问题](blog/0.TroubleShooting/1.观察日志/2.fastjson升级不兼容的问题.md)
		- [3.这不是我想要的日志](blog/0.TroubleShooting/1.观察日志/3.这不是我想要的日志.md)
		- [4.模糊的异常信息让人蒙圈](blog/0.TroubleShooting/1.观察日志/4.模糊的异常信息让人蒙圈.md)
		- [5.刚发现的虫子原来很早之前就有了](blog/0.TroubleShooting/1.观察日志/5.刚发现的虫子原来很早之前就有了.md)
		- [6.发现冲突，解决冲突](blog/0.TroubleShooting/1.观察日志/6.发现冲突，解决冲突.md)
		- [7.小心JS中数字精度损失](blog/0.TroubleShooting/1.观察日志/7.小心JS中数字精度损失.md)
		- [8.STFP报错Connection_reset](blog/0.TroubleShooting/1.观察日志/8.STFP报错Connection_reset.md)
		- [9.返回值里藏着异常信息](blog/0.TroubleShooting/1.观察日志/9.返回值里藏着异常信息.md)
		- [10.看堆栈，勿急躁](blog/0.TroubleShooting/1.观察日志/10.看堆栈，勿急躁.md)
		- [11.归约问题定位思路](blog/0.TroubleShooting/1.观察日志/11.归约问题定位思路.md)
		- [12.CA认证的证书为什么还需要手动导入？](blog/0.TroubleShooting/1.观察日志/12.CA认证的证书为什么还需要手动导入？.md)
		- [13.Http上传文件的Content-Type格式](blog/0.TroubleShooting/1.观察日志/13.Http上传文件的Content-Type格式.md)
		- [14.nginx反向代理自调用时小心Header里的host](blog/0.TroubleShooting/1.观察日志/14.nginx反向代理自调用时小心Header里的host.md)
		- [15.Webmethod的IS加入Cluster异常](blog/0.TroubleShooting/1.观察日志/15.Webmethod的IS加入Cluster异常.md)
	- [2.Debug](blog/0.TroubleShooting/2.Debug)
		- [1.el中函数调用结果始终为null](blog/0.TroubleShooting/2.Debug/1.el中函数调用结果始终为null.md)
		- [2.Debug时科学观察变量](blog/0.TroubleShooting/2.Debug/2.Debug时科学观察变量.md)
		- [3.Debug时加的观察变量影响了debug](blog/0.TroubleShooting/2.Debug/3.Debug时加的观察变量影响了debug.md)
		- [4.ClassNotFound与类加载的全盘委托机制](blog/0.TroubleShooting/2.Debug/4.ClassNotFound与类加载的全盘委托机制.md)
		- [5.日志先行，Debug其次](blog/0.TroubleShooting/2.Debug/5.日志先行，Debug其次.md)
	- [3.思维定势](blog/0.TroubleShooting/3.思维定势)
		- [1.对Http响应码“302”的误判](blog/0.TroubleShooting/3.思维定势/1.对Http响应码“302”的误判.md)
	- [4.流程分析](blog/0.TroubleShooting/4.流程分析)
		- [1.原来是IDE和Rest版本不同步](blog/0.TroubleShooting/4.流程分析/1.原来是IDE和Rest版本不同步.md)
		- [2.FTP和sshuttle的故事](blog/0.TroubleShooting/4.流程分析/2.FTP和sshuttle的故事.md)
		- [3.方法返回集合的副本，避免污染](blog/0.TroubleShooting/4.流程分析/3.方法返回集合的副本，避免污染.md)
		- [4.签名验证异常](blog/0.TroubleShooting/4.流程分析/4.签名验证异常.md)
		- [5.HttpClient未设置connectTimeout导致线程池耗尽](blog/0.TroubleShooting/4.流程分析/5.HttpClient未设置connectTimeout导致线程池耗尽.md)
		- [6.用tcpdump、wireShark分析sftp连接时readtimeout](blog/0.TroubleShooting/4.流程分析/6.用tcpdump、wireShark分析sftp连接时readtimeout.md)
		- [7.MQ积压2亿了](blog/0.TroubleShooting/4.流程分析/7.MQ积压2亿了.md)
		...
		- [11.commons-io依赖冲突](blog/0.TroubleShooting/4.流程分析/11.commons-io依赖冲突.md)
		...
		- [14.内存飚高排查（一）](blog/0.TroubleShooting/4.流程分析/14.内存飚高排查（一）.md)
		- [15.内存飚高排查（二）](blog/0.TroubleShooting/4.流程分析/15.内存飚高排查（二）.md)
		- [16.内存飚高排查（三）](blog/0.TroubleShooting/4.流程分析/16.内存飚高排查（三）.md)
		- [17.内存飚高排查（四）](blog/0.TroubleShooting/4.流程分析/17.内存飚高排查（四）.md)
	- [5.单元测试](blog/0.TroubleShooting/5.单元测试)
		...
		- [3.因浮点精度损失了1分钱](blog/0.TroubleShooting/5.单元测试/3.因浮点精度损失了1分钱.md)
- [1.java](blog/1.java)
	...
	- [22.Java异常堆栈丢失仅剩一行](blog/1.java/22.Java异常堆栈丢失仅剩一行.md)
