...
1. 类加载到哪里了？方法区还是堆？
## 二、JVM结构图
![内存结构图](pic/1240-20210115023450080.png)
## 三、类加载顺序

### 1、加载顺序

![类加载过程](pic/1240-20210115023450159.png)
...
![类继承结构](pic/1240-20210115023450036-0649290.png)
...
## 五、双亲委派和全盘委托
![双亲委派](pic/1240-20210115023450036.png)
