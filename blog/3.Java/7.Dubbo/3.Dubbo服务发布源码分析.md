...
![/dev-guide/images/dubbo-export.jpg](pic/dubbo-export.jpg)
...
<img src="pic/image-20210516232619487.png" alt="image-20210516232619487"  />

### 四、ServiceConfig对ProxyFactory结果再次封装

`DelegateProviderMetaDataInvoker wrapperInvoker = new DelegateProviderMetaDataInvoker(invoker, this);`

![image-20210516232958512](pic/image-20210516232958512.png)
...
![image-20210517000543761](pic/image-20210517000543761.png)
...
![image-20210516235557344](pic/image-20210516235557344.png)
...
![image-20210517001936404](pic/image-20210517001936404.png)
...
![image-20210517003347876](pic/image-20210517003347876.png)
...
![image-20210525234719381](pic/image-20210525234719381.png)

### 七、服务发布最终结构

![image-20210525235040075](pic/image-20210525235040075.png)
