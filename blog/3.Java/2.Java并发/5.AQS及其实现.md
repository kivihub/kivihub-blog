...
![AQS类继承结构](pic/1240-20210115024759154.png)
...
### 4、AQS和monitor关系
![monitor](pic/1240-20210115024759159.png)

![AQS](pic/1240-20210115024759365.png)
...
### 5、AQS的获取方法
<img src="pic/1240-20210115024759378.png" alt="image.png" style="zoom:67%;" />


### 6、AQS的acquire和acquireShared流程图

![acquire流程图](pic/1240-20210115024759428.png)

![acquireShared流程](pic/1240-20210115024759437.png)
...
### 7、AQS的release方法流程图
![release方法流程流程图](pic/1240-20210115024759287.png)

![releaseShared方法流程图](pic/1240-20210115024759417.png)
...
<img src="pic/1240-20210115024934909.png" alt="类继承结构" style="zoom: 50%;" />

![image-20220318134246150](pic/image-20220318134246150.png)



![tryRelease流程](pic/1240-20210115024935073.png)

### 2、ReentrantReadWriteLock

> state为int类型，高16位用于读锁，低16位用于写锁。默认非公平锁。

<img src="pic/1240-20210115024935443.png" alt="ReentrantReadWriteLock结构" style="zoom:67%;" />

<img src="pic/1240-20210115024935515.png" alt="读锁获取过程" style="zoom:67%;" />

![写锁获取过程](pic/1240-20210115024935053.png)

<img src="pic/1240-20210115024935463.png" alt="读锁释放过程" style="zoom:67%;" />

![写锁释放过程](pic/1240-20210115024935338.png)

### 3、Semaphore

> state表示许可数量。默认非公平锁。

<img src="pic/1240-20210115024935320.png" alt="Semaphore公平锁获取许可流程" style="zoom:67%;" />

<img src="pic/1240-20210115024935466.png" alt="Semaphore非公平锁获取许可流程" style="zoom:67%;" />

![Semaphore释放许可流程](pic/1240-20210115024935518-0650175.png)

### 4、CountDownLatch

> state是初始化时传入的参数。

![countDown](pic/1240-20210115024935508.png)

![await](pic/1240-20210115024935503.png)
