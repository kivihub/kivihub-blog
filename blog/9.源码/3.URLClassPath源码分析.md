...
#### 二、URLClassLoader
URLClassLoader的作用是依赖URLClassPath来定位读取资源，可参考文章[类加载机制](../3.java/3.jvm/1.类加载机制.md)
...
![image-20210129110906108](../../src/main/resources/picture/image-20210129110906108.png)
