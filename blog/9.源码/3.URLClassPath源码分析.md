...
#### 二、URLClassLoader
URLClassLoader的作用是依赖URLClassPath来定位读取资源，可参考文章[类加载机制](https://www.jianshu.com/p/aeadf6c31b53)
![URLClassPath的类继承结构](../../src/main/resources/picture/1240-20210115040318080.png)
##### 关键代码：
```java
...
![Loader的继承层次](https://upload-images.jianshu.io/upload_images/7914265-63e3efcf44d44f0c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
