...
1. Gnome插件
   ...
   1. [Simple system monitor](https://extensions.gnome.org/extension/4506/simple-system-monitor/) - 顶部栏显示系统监控信息
   1. Dynamic Panel Transparency  - 顶栏透明设置
   1. [Clipboard Indicator](https://extensions.gnome.org/extension/779/clipboard-indicator/) - 剪切板Gnome扩展
   1. Remove Dropdown Arrows - 移除顶栏右侧向下箭头
   1. Hide Activities Button - 移除顶栏左侧Activities按钮
   1. TopIconsFix - 系统托盘修复，顶栏显示wine运行中程序
1. 键鼠多设备共享
...
1. 截图/录屏
   ...
   1. [Peek](https://launchpad.net/~peek-developers/+archive/ubuntu/stable) - 录屏生成gif/mp4，便于客户答疑
1. 翻译软件
...
1. zsh + ohmyzsh（自动补全 & 语法提示插件）- shell
### 2、开发
...
1. [KeyStore Explorer](https://keystore-explorer.org/index.html) - keytool GUI工具，管理cacerts证书库
1. [EDIdEv SefReader](https://www.edidev.com/eval_SefReader.html) - SEF文件读取工具

#### 附桌面

![桌面](../../src/main/resources/picture/桌面.png)
...
![image-20211118112808893](../../src/main/resources/picture/image-20211118112808893.png)
...
![image-20211125143338218](../../src/main/resources/picture/image-20211125143338218.png)

3）配置动作

![image-20211125143510964](../../src/main/resources/picture/image-20211125143510964.png)
...
![image-20211125143551907](../../src/main/resources/picture/image-20211125143551907.png)

5）首选项中取消菜单中的根菜单

![image-20211125143629656](../../src/main/resources/picture/image-20211125143629656.png)
